if (typeof CoinWidget != 'object')
    var CoinWidget = {
        ...
        load_jquery: function(){
            ...
            CoinWidget.load_script('COINWIDGET_JQUERY','http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js',function(){
        ...
        init: function(config){
            ...
            CoinWidget.load_css('COINWIDGET_CSS','css/btcwidget.css');
        ...
        build:function(info,instance){
            ...
            var ext_html = CoinWidget.instance_config[instance].counter == 'hide'
                ...
                : ($counter != 'undefined'
                ? '<span>'+ $counter+'</span>'
                : '<span><img src="http://d1e4zb60eak76i.cloudfront.net/load.gif" width="12" height="12" /></span>'
                );
        ...
        build_window: function(instance){
            ...
            if (!CoinWidget.instance_config[instance].hide_qr) {
                ext_html += '<img width="16" height="16" class="COINWIDGET_QR" src="http://d1e4zb60eak76i.cloudfront.net/qr.png" /><img width="113" height="113" class="COINWIDGET_QR_LARGE" src="//d1e4zb60eak76i.cloudfront.net" />';
            }
